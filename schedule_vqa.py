...
top_details = "Running partial data experiments on VQA with LXMERT"

hyperparameters = [
    [('extra_flags',), ['', '--num_images 1000', '--num_images 5000', '--num_images 10000', '--num_images 20000', '--num_images 40000']],
]
...
for combo in combinations:
    ...
    with open("vqa_finetune_template_%s.sh" % username, 'r') as f:
    ...
    script_name = 'schedulers/schedule_vqa_%d.sh' % run_id
